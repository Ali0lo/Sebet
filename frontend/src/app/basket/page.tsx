...
export default function BasketPage() {
  ...
  const handleRunOptimizer = async () => {
    ...
    try {
      ...
      const res = await optimizeBasket(
        ...
        750.0 // Default opinionated walking radius
      );
  ...
  // Re-run optimizer whenever items or quantities in basket change
  ...
  }, [basketSignature, selectedLocation.name, isMounted]);
  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      {/* Location Badge */}
      <div className="flex items-center justify-between px-3.5 py-2.5 rounded-2xl bg-slate-100/90 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {isSplitViable && bestSplit && primaryStore && secondaryStore ? (
                  ...
                  <div className="p-4 rounded-3xl border border-dashed border-slate-300 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/40 text-left flex flex-col justify-between opacity-75 select-none">
                    ...
                    <div className="pt-3 mt-2 border-t border-slate-200/80 dark:border-slate-800 flex items-baseline justify-between text-xs text-slate-400">
