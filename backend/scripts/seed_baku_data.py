...
CHAINS_DATA = [
    ...
    },
    {
        ...
        "slug": "oba",
        "color": "#009640",
        "logo_url": "https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=120&auto=format&fit=crop&q=80",
    },
    {
        "name": "Bazarstore",
        "slug": "bazarstore",
        "color": "#D01026",
        "logo_url": "https://images.unsplash.com/photo-1534723452862-4c874018d66d?w=120&auto=format&fit=crop&q=80",
    },
]
...
PRODUCTS_DATA = [
    # 1. Dairy & Eggs
    {
        ...
        "base_price": 2.25,
        "variations": {"oba": 2.10, "araz": 2.25, "bravo": 2.35, "bazarstore": 2.39},
    ...
    },
    {
        ...
        "base_price": 2.45,
        "variations": {"oba": 2.30, "araz": 2.45, "bravo": 2.50, "bazarstore": 2.55},
        "promo": None,
    },
    {
        ...
        "base_price": 2.15,
        "variations": {"oba": 1.99, "araz": 2.15, "bravo": 2.20, "bazarstore": 2.25},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=400&auto=format&fit=crop&q=80",
        "base_price": 5.20,
        "variations": {"oba": 4.90, "araz": 5.10, "bravo": 5.20, "bazarstore": 5.35},
        "promo": {"chain": "bravo", "promo_price": 4.49},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=400&auto=format&fit=crop&q=80",
        "base_price": 5.30,
        "variations": {"oba": 5.00, "araz": 5.25, "bravo": 5.30, "bazarstore": 5.40},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&auto=format&fit=crop&q=80",
        "base_price": 1.70,
        "variations": {"oba": 1.55, "araz": 1.70, "bravo": 1.75, "bazarstore": 1.80},
        "promo": None,
    },
    {
        ...
        "base_price": 2.20,
        "variations": {"oba": 1.95, "araz": 2.15, "bravo": 2.20, "bazarstore": 2.30},
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=400&auto=format&fit=crop&q=80",
        "base_price": 2.10,
        "variations": {"oba": 1.90, "araz": 2.05, "bravo": 2.10, "bazarstore": 2.15},
        "promo": None,
    },
    {
        ...
        "base_price": 6.80,
        "variations": {"oba": 6.20, "araz": 6.60, "bravo": 6.80, "bazarstore": 7.10},
        "promo": None,
    },
    ...
    # 2. Pantry & Cooking
    {
        ...
        "base_price": 2.35,
        "variations": {"oba": 2.15, "araz": 2.30, "bravo": 2.45, "bazarstore": 2.45},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1563227812-0ea4c22e6cc8?w=400&auto=format&fit=crop&q=80",
        "base_price": 4.10,
        "variations": {"oba": 3.80, "araz": 4.05, "bravo": 4.20, "bazarstore": 4.25},
        "promo": None,
    },
    {
        ...
        "base_price": 4.80,
        "variations": {"oba": 4.40, "araz": 4.70, "bravo": 4.80, "bazarstore": 4.60},
        "promo": {"chain": "bazarstore", "promo_price": 4.19},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&auto=format&fit=crop&q=80",
        "base_price": 3.90,
        "variations": {"oba": 3.50, "araz": 3.80, "bravo": 3.90, "bazarstore": 3.85},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&auto=format&fit=crop&q=80",
        "base_price": 17.50,
        "variations": {"oba": 15.90, "araz": 16.90, "bravo": 17.50, "bazarstore": 16.99},
        "promo": {"chain": "oba", "promo_price": 14.99},
    },
    {
        ...
        "base_price": 4.20,
        "variations": {"oba": 3.80, "araz": 4.10, "bravo": 4.20, "bazarstore": 4.25},
        "promo": None,
    },
    {
        ...
        "base_price": 1.55,
        "variations": {"oba": 1.40, "araz": 1.55, "bravo": 1.60, "bazarstore": 1.65},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1612927601601-6638404737ce?w=400&auto=format&fit=crop&q=80",
        "base_price": 1.55,
        "variations": {"oba": 1.40, "araz": 1.50, "bravo": 1.60, "bazarstore": 1.65},
        "promo": None,
    },
    {
        ...
        "base_price": 2.70,
        "variations": {"oba": 2.45, "araz": 2.65, "bravo": 2.70, "bazarstore": 2.75},
        "promo": None,
    },
    {
        ...
        "base_price": 1.85,
        "variations": {"oba": 1.75, "araz": 1.85, "bravo": 1.90, "bazarstore": 1.85},
        "promo": None,
    },
    {
        ...
        "base_price": 0.80,
        "variations": {"oba": 0.65, "araz": 0.75, "bravo": 0.80, "bazarstore": 0.85},
        "promo": None,
    },
    {
        ...
        "base_price": 3.40,
        "variations": {"oba": 3.10, "araz": 3.35, "bravo": 3.45, "bazarstore": 3.20},
        "promo": {"chain": "bazarstore", "promo_price": 2.89},
    },
    ...
    # 3. Beverages & Tea
    {
        ...
        "base_price": 4.10,
        "variations": {"oba": 3.75, "araz": 3.99, "bravo": 4.20, "bazarstore": 3.90},
        "promo": {"chain": "araz", "promo_price": 3.49},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1597481499750-3e6b22637e12?w=400&auto=format&fit=crop&q=80",
        "base_price": 2.10,
        "variations": {"oba": 1.85, "araz": 2.05, "bravo": 2.15, "bazarstore": 2.00},
        "promo": None,
    },
    {
        ...
        "base_price": 0.95,
        "variations": {"oba": 0.85, "araz": 0.90, "bravo": 1.05, "bazarstore": 1.00},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1548839140-29a749e1bc4e?w=400&auto=format&fit=crop&q=80",
        "base_price": 1.10,
        "variations": {"oba": 0.95, "araz": 1.05, "bravo": 1.15, "bazarstore": 1.10},
        "promo": None,
    },
    {
    ...
    },
    {
        ...
        "base_price": 2.10,
        "variations": {"oba": 1.95, "araz": 2.05, "bravo": 2.15, "bazarstore": 2.10},
        "promo": {"chain": "bravo", "promo_price": 1.79},
    },
    {
    ...
    },
    {
        ...
        "base_price": 13.90,
        "variations": {"oba": 12.50, "araz": 13.50, "bravo": 13.90, "bazarstore": 14.20},
        "promo": {"chain": "araz", "promo_price": 11.49},
    },
    {
        ...
        "base_price": 3.60,
        "variations": {"oba": 3.20, "araz": 3.50, "bravo": 3.65, "bazarstore": 3.60},
        "promo": None,
    },
    ...
    # 4. Cleaning & Household
    {
        ...
        "base_price": 10.50,
        "variations": {"oba": 9.80, "araz": 10.30, "bravo": 9.20, "bazarstore": 10.80},
        "promo": {"chain": "bravo", "promo_price": 8.49},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=400&auto=format&fit=crop&q=80",
        "base_price": 12.80,
        "variations": {"oba": 11.90, "araz": 12.50, "bravo": 12.80, "bazarstore": 12.99},
        "promo": None,
    },
    {
        ...
        "base_price": 3.80,
        "variations": {"oba": 3.35, "araz": 3.70, "bravo": 3.85, "bazarstore": 3.90},
        "promo": {"chain": "oba", "promo_price": 2.99},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1585670270608-b4be4fb88092?w=400&auto=format&fit=crop&q=80",
        "base_price": 3.95,
        "variations": {"oba": 3.50, "araz": 3.85, "bravo": 3.95, "bazarstore": 4.10},
        "promo": None,
    },
    {
        ...
        "base_price": 3.80,
        "variations": {"oba": 3.40, "araz": 3.65, "bravo": 3.80, "bazarstore": 3.95},
        "promo": None,
    },
    {
        ...
        "base_price": 6.20,
        "variations": {"oba": 5.40, "araz": 5.95, "bravo": 6.20, "bazarstore": 6.40},
        "promo": {"chain": "oba", "promo_price": 4.89},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1584556812952-905ffd0c611a?w=400&auto=format&fit=crop&q=80",
        "base_price": 3.40,
        "variations": {"oba": 2.90, "araz": 3.25, "bravo": 3.40, "bazarstore": 3.50},
        "promo": None,
    },
    {
    ...
    # 5. Snacks & Sweets
    {
        ...
        "base_price": 0.80,
        "variations": {"oba": 0.72, "araz": 0.80, "bravo": 0.85, "bazarstore": 0.85},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=400&auto=format&fit=crop&q=80",
        "base_price": 0.70,
        "variations": {"oba": 0.60, "araz": 0.70, "bravo": 0.75, "bazarstore": 0.75},
        "promo": None,
    },
    {
        ...
        "base_price": 2.90,
        "variations": {"oba": 2.65, "araz": 2.85, "bravo": 2.95, "bazarstore": 3.00},
        "promo": {"chain": "bravo", "promo_price": 2.39},
    },
    {
        ...
        "base_price": 2.40,
        "variations": {"oba": 2.10, "araz": 2.35, "bravo": 2.45, "bazarstore": 2.50},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&auto=format&fit=crop&q=80",
        "base_price": 4.90,
        "variations": {"oba": 4.30, "araz": 4.80, "bravo": 5.10, "bazarstore": 4.90},
        "promo": None,
    },
    ...
    # 6. Personal Care & Baby
    {
        ...
        "base_price": 23.50,
        "variations": {"oba": 21.90, "araz": 22.90, "bravo": 23.50, "bazarstore": 24.20},
        "promo": {"chain": "bravo", "promo_price": 19.99},
    },
    {
        ...
        "base_price": 5.80,
        "variations": {"oba": 5.10, "araz": 5.65, "bravo": 5.85, "bazarstore": 6.00},
        "promo": None,
    },
    {
        ...
        "base_price": 6.50,
        "variations": {"oba": 5.80, "araz": 6.30, "bravo": 6.60, "bazarstore": 6.70},
        "promo": {"chain": "araz", "promo_price": 5.19},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=400&auto=format&fit=crop&q=80",
        "base_price": 5.20,
        "variations": {"oba": 4.70, "araz": 5.10, "bravo": 5.30, "bazarstore": 5.40},
        "promo": None,
    },
    {
        ...
        "base_price": 4.50,
        "variations": {"oba": 3.90, "araz": 4.40, "bravo": 4.60, "bazarstore": 4.70},
        "promo": None,
    },
    {
        ...
        "promo": {"chain": "bravo", "promo_price": 3.49},
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&auto=format&fit=crop&q=80",
        "base_price": 5.40,
        "variations": {"oba": 4.90, "araz": 5.25, "bravo": 5.45, "bazarstore": 5.60},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=400&auto=format&fit=crop&q=80",
        "base_price": 4.60,
        "variations": {"oba": 4.15, "araz": 4.45, "bravo": 4.65, "bazarstore": 4.70},
        "promo": None,
    },
    {
    ...
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&auto=format&fit=crop&q=80",
        "base_price": 2.20,
        "variations": {"oba": 1.90, "araz": 2.10, "bravo": 2.25, "bazarstore": 2.30},
        "promo": None,
    },
    {
        ...
        "image_url": "https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=400&auto=format&fit=crop&q=80",
        "base_price": 16.80,
        "variations": {"oba": 14.90, "araz": 16.20, "bravo": 16.80, "bazarstore": 17.20},
        "promo": {"chain": "bravo", "promo_price": 13.99},
    },
]
    ...
    async with async_session_factory() as session:
        ...
        for pdata in PRODUCTS_DATA:
            ...
            for st in STORES_DATA:
                ...
                # Small random variation by branch (+/- 0.05 AZN)
        ...
        flyers_info = [
            {
                ...
                "items": [
                    {"barcode": "8001090123456", "title": "Ariel Yuyucu Toz 3kg", "disc": 8.49, "orig": 10.50, "pct": 19, "badge": "Super Endirim"},
                    {"barcode": "9415494000125", "title": "Westgold Kərə Yağı 200g", "disc": 4.49, "orig": 5.20, "pct": 14, "badge": "Yeni Təklif"},
                    {"barcode": "5449000000996", "title": "Coca-Cola Classic 1.5L", "disc": 1.79, "orig": 2.10, "pct": 15, "badge": "1+1 Fürsəti"},
                ]
            },
            {
                "chain_slug": "araz",
                ...
                "items": [
                    {"barcode": "4760012300124", "title": "Azərçay Buket 250g", "disc": 3.49, "orig": 4.10, "pct": 15, "badge": "Çay Mövsümü"},
                    {"barcode": "4760123456789", "title": "Giləzi Yumurtası 10-lu", "disc": 1.79, "orig": 2.20, "pct": 19, "badge": "Sərfəli Qənaət"},
                    {"barcode": "8001090543210", "title": "Pantene Şampun 400ml", "disc": 5.19, "orig": 6.50, "pct": 20, "badge": "Xüsusi Qiymət"},
                ]
            },
            {
                "chain_slug": "oba",
                ...
                "items": [
                    {"barcode": "4760083300124", "title": "Milla Süd 2.5% 1L", "disc": 1.99, "orig": 2.25, "pct": 12, "badge": "Hər Gün Ucuz"},
                    {"barcode": "4760032100147", "title": "Final Yağı 5L", "disc": 14.99, "orig": 17.50, "pct": 14, "badge": "Ailəvi Boy"},
                    {"barcode": "8690530012345", "title": "Papia Tualet Kağızı 8-li", "disc": 4.89, "orig": 6.20, "pct": 21, "badge": "Super Fürsət"},
                ]
            },
            {
                "chain_slug": "bazarstore",
                ...
                "items": [
                    {"barcode": "4760032100123", "title": "Möcüzə Qarğıdalı Yağı 1L", "disc": 4.19, "orig": 4.80, "pct": 13, "badge": "Azersun Endirimi"},
                    {"barcode": "4760078901265", "title": "Bizim Tarla Tomat Pastası 720g", "disc": 2.89, "orig": 3.40, "pct": 15, "badge": "Mətbəx Fürsəti"},
                ]
            }
        ]
        ...
        print("👤 Seeding demo user (Ali İsgəndərli, +994 50 123 45 67, 250 SebEt Points)...")
        demo_user = User(
        ...
        print("   - 1 Demo User with 250 SebEt Points")
